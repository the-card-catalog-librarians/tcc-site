...
description: "Learn how the Dewey Decimal System organizes knowledge by breaking subjects into main classes, divisions, and detailed subdivisions, using examples from physics and zoology to show how numbers to the left of the decimal indicate broad categories while numbers to the right add precise specificity, helping libraries label and locate books efficiently."
---

> NOTE: Both Michelle Howard, the author of this informative post,
> and [Liz Cottrill and Emily Kiser of Living Books Library in Tennessee](https://www.livingbookslibrary.com/) highly
> recommend using the Dewey Decimal System to classify and organize your books. You can
> use [LibraryThing](https://www.librarything.com/) or [Michelle’s library database](http://www.livingbookslady.com/) to
