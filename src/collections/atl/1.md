...
description: "A library discovered mold in children's books due to condensation from closed ceiling vents, prompting a thorough cleanup: infected books were discarded, shelves emptied and sanitized, over 2,200 books cleaned and re‑tagged, the kitchenette’s particleboard replaced, plastic baskets added, ozone treatments run, dehumidifiers upgraded, and the room reorganized, with humidity monitoring installed to prevent future issues."
