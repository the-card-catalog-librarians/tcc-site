...
description: "A private living books lending library is a home‑based library where a librarian shares a curated collection of “living books” with the community, often through a membership model that includes loan periods and member responsibilities. To start one, pray for guidance, assess your collection, organize and catalog the books, decide on pricing and policies, promote the library locally, and begin lending, gradually expanding as you grow."
...
1. Figure out about how many books you have and arrange them on shelves. Organize the books in whatever way makes sense
   to you, and if you plan to have people come inside your library to browse, whatever way will make sense to them.
