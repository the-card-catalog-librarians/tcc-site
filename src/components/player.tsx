...
import { PlayIcon, PauseIcon, VolumeXIcon, RadioIcon, VolumeIcon, Volume1Icon, Volume2Icon, RewindIcon, FastForwardIcon, SkipForwardIcon, SkipBackIcon, MusicIcon, XIcon, ListMusicIcon, Repeat1Icon, RepeatIcon, ShuffleIcon, SlidersHorizontalIcon, GaugeIcon } from "lucide-react";
...
const AudioPlayerTimeDisplay = ({
  ...
  return (
    ...
    >
      {showLiveIcon && (
        <RadioIcon className="size-3 shrink-0 animate-pulse" />
      )}
      {timeValue}
    </time>
  );
